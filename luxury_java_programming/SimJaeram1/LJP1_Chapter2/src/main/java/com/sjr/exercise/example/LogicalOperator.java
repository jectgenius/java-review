...
public class LogicalOperator {                      // LogicalOperator 클래스 정의 시작
    public static void main(String[] args) {        // main() 메소드 정의 시작
        // 비교 연산자
        System.out.println('a' > 'b');              // System.out.println() 메소드 호출하여 'a' > 'b' 연산 결과 출력, false
        System.out.println(3 >= 2);                 // System.out.println() 메소드 호출하여 3 >= 2 연산 결과 출력, true
        System.out.println(-1 < 0);                 // System.out.println() 메소드 호출하여 -1 < 0 연산 결과 출력, true
        System.out.println(3.45 <= 2);              // System.out.println() 메소드 호출하여 3.45 <= 2 연산 결과 출력, false
        System.out.println(3 == 2);                 // System.out.println() 메소드 호출하여 3 == 2 연산 결과 출력, false
        System.out.println(3 != 2);                 // System.out.println() 메소드 호출하여 3 != 2 연산 결과 출력, true
        System.out.println(!(3 != 2));              // System.out.println() 메소드 호출하여 !(3 != 2) 연산 결과 출력, false
